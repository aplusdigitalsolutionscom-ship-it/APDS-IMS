...
import { Loader2, Users, History, FileText, User } from 'lucide-react';

const UsersComp = lazy(() => import('./Users'));
const UserActivityComp = lazy(() => import('./UserActivity'));
const ReportsComp = lazy(() => import('./Reports'));
const ProfilePageComp = lazy(() => import('./ProfilePage'));
