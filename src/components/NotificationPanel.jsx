...
export default function NotificationPanel({ currentUser, placement = "bottom", onOpenOrderFromNotification }) {
  ...
  useEffect(() => {
    ...
    const evtSource = new EventSource(`${import.meta.env.VITE_API_URL}/api/notifications/stream?token=${token}`);
    ...
    evtSource.onmessage = function (event) {
      ...
      try {
        ...
        if (data.type === 'NEW_NOTIFICATION') {
          ...
          // Show native toast if supported
